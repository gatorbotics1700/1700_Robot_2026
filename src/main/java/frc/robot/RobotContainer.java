...
public class RobotContainer {
  ...
  public void configureSysIdButtonBindings(CommandXboxController controller) {
    controller.y().whileTrue(shooterSubsystem.sysIdDynamic(SysIdRoutine.Direction.kReverse));
    controller.x().whileTrue(shooterSubsystem.sysIdDynamic(SysIdRoutine.Direction.kForward));
    controller.b().whileTrue(shooterSubsystem.sysIdQuasistatic(SysIdRoutine.Direction.kReverse));
    controller.a().whileTrue(shooterSubsystem.sysIdQuasistatic(SysIdRoutine.Direction.kForward));
  }
