...
//  *
//  * <p>Fill in the TEMPLATE_* values below with a known scenario: robot pose, camera setup,
// detected
//  * target pitch/yaw from PhotonVision, and the theoretically correct outputs. The tests will
// verify
...
//   /**
//    * Optional override for getCameraToTargetDistance: camera height (cm). Set to -1 to use
// config.
//    */
...
//       fail(
//           "Fill in TEMPLATE_* values and set TEMPLATE_IS_FILLED_IN = true to run this test. "
//               + "You need: robot pose, target pitch/yaw from PhotonVision, and expected fuel
// pose.");
//     }
...
//     // array inside getFuelPose, so we must mutate it before calling
...
//               "getCameraToTargetDistance", double.class, double.class, double.class,
// double.class);
...
//       return new Vision((pose, timestamp, stdDevs) -> {},
// cameraUnderTest).getFuelPose(robotPose);
//     }
